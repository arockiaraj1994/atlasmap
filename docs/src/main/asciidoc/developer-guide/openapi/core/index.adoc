...
Create a dedicated workspace for a mappingDefinitionId


// markup not found, no include::{specDir}workspace/\{workspaceId\}/POST/spec.adoc[opts=optional]
...
// markup not found, no include::{snippetDir}workspace/\{workspaceId\}/POST/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}workspace/\{workspaceId\}/POST/http-response.adoc[opts=optional]



// file not found, no * wiremock data link :workspace/{workspaceId}/POST/POST.json[]


ifdef::internal-generation[]
===== Implementation

// markup not found, no include::{specDir}workspace/\{workspaceId\}/POST/implementation.adoc[opts=optional]
